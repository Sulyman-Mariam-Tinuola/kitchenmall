...
<h1 className='text-5xl font-semibold tracking-normal'>Get your quality and affordable kitchen items</h1>
<div className='bg-white flex items-center space-x-2 px-5 py-2 rounded-full'>
<AiOutlineSearch size={'1.2rem'}/>
<input className='outline-0 w-full' type='text' placeholder='Search here...'/>
</div>
        </div>
